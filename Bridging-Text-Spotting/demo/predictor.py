...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image):
        ...
        # predictions['instances'].boxes *= 1.5
        
        # If we have instances and we're working with bezier/polygon data
        if "instances" in predictions and self.vis_text:    # t
            # If we need to convert bezier/polygon to bounding boxes
            ctrl_pnts = predictions["instances"].polygons   # 6 32
            ctrl_pnts = ctrl_pnts.cpu().numpy()
