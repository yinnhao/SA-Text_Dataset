...
if __name__ == "__main__":
    ...
    if args.input:
        ...
        # for path in args.input:
            ...
            try:
                ...
                results["images"].append({
                    ...
                    "width": width,
                    "height": height,
                    "instances": len(predictions["instances"].scores)
                })
                if "instances" in predictions:
                    ...
                    for i in range(len(scores)):
                        # Convert box from [x_min, y_min, x_max, y_max] to COCO format [x_min, y_min, width, height]
                        box = boxes[i]
                        ...
                        if polygons and i < len(polygons):
                            # Reshape polygon to pairs of [x,y] coordinates
                            polygon = polygons[i]
                            points = []
        ...
        output_json_path = os.path.join(args.output if args.output and os.path.isdir(args.output) else ".", 
                                       f"text_detection_results.json")
