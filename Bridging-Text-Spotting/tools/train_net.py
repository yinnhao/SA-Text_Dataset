...
def main(args):
    ...
    if args.eval_only:
        ...
        return res
#     (Pdb) model.bridge.blocks[0].attns.qkv.weight
# *** AttributeError: 'Block' object has no attribute 'attns'. Did you mean: 'attn'?
# (Pdb) model.bridge.blocks[0].attn.qkv.weight
# Parameter containing:
# tensor([[-0.0143, -0.0455, -0.0208,  ..., -0.0503, -0.0317, -0.0017],
#         [-0.0125, -0.0076, -0.0219,  ...,  0.0036, -0.0181,  0.0209],
#         [ 0.0425, -0.0034,  0.0290,  ...,  0.0316,  0.0080, -0.0271],
#         ...,
#         [-0.0332,  0.0438,  0.0328,  ...,  0.0105, -0.0533, -0.0026],
#         [-0.0462,  0.0188,  0.0060,  ...,  0.0207,  0.0082, -0.0166],
#         [-0.0506,  0.0013,  0.0352,  ...,  0.0472, -0.0408,  0.0521]],
